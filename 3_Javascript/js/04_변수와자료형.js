...
function typeTest(){
    ...
    typeBox.innerHTML = ""; // typeBox 요소 내부의 내용을 빈문자열로 바꿔라
                            // 내부 내용 삭제

    // const name2; // 상수는 선언과 동시에 초기화가 필수

    // let name = "홍길동"; // undifiend -> string

    let name;
    typeBox.innerHTML += "name : " + name + " / " + typeof name;

    
    name = "홍길동";  // undifiend -> string
    ...
    // 함수명만 작성하는 경우 -> 함수에 작성된 코드 자체가 반환(실행 X)
