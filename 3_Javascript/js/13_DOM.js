...
document.getElementById("btn1").addEventListener("click" , function(){
    ...
    // #li1의 부모 노드의 마지막 부분에 "ABCD"라는 text node추가
    ...
    // #test자식 노드 중 5번째 인덱스 노드의 마지막자식으로 "ZZZ"추가하기
    test.childNodes[5].append("ZZZ")

    // #test의 자식 노드 중 5번 인덱스의 이전 형태 노드
    console.log(test.childNodes[5].previousSibling); // >4번
    
    // #test의 자식 노드 중 5번 인덱스의 다음 형태 노드
    console.log(test.childNodes[5].nextSibling); // 6번

    // 노드 탐색 구문 연속 작성
    // #test의 자식 녿 중 5번 인덱스의 이전 형제 노드의 이전 형제 노드
...
document.getElementById("btn2").addEventListener("click", function(){
    ...
    // #li1의 부모 요소의 부모요소 탐색
    console.log(li1.parentElement.parentElement); // 바디태그
